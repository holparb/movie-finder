...
// in movie_finder/test/presentation/bloc/movie_details/movie_details_bloc_test.dart.
...
import 'package:movie_finder/domain/usecases/get_movie_details.dart' as _i4;
...
class MockGetMovieDetailsUseCase extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.DataState<_i6.Movie>> call({int? params}) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
        ...
        returnValue: _i5.Future<_i3.DataState<_i6.Movie>>.value(
            _FakeDataState_1<_i6.Movie>(
          this,
          Invocation.method(
            #call,
            [],
      ...
      ) as _i5.Future<_i3.DataState<_i6.Movie>>);
}
