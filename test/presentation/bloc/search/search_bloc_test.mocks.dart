...
// in movie_finder/test/presentation/bloc/search/search_bloc_test.dart.
...
import 'package:movie_finder/domain/usecases/search_movies.dart' as _i3;
...
class MockSearchMoviesUseCase extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.DataState<List<_i5.Movie>>> call({String? params = r''}) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
