...
// in movie_finder/test/presentation/bloc/movies/watchlist_bloc_test.dart.
...
import 'package:movie_finder/domain/usecases/is_movie_on_watchlist.dart' as _i6;
...
class MockIsMovieOnWatchlistUseCase extends _i1.Mock
    implements _i6.IsMovieOnWatchlistUseCase {
  MockIsMovieOnWatchlistUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<bool> call({int? params}) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [],
          {#params: params},
